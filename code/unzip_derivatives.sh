#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/Shoreline/full_benchmark/shoreline-benchmark/output_ria#f8dbe3f8-b4d0-47ae-8b07-cb4e0a5f03b8
cd /cbica/projects/Shoreline/full_benchmark/shoreline-benchmark
